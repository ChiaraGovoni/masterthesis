...
def interactive_survey_final():
    ...
    print("This DSS was developed to offer guidance to startups offering Cloud Computing services, and facing the “Pioneer Problem”. This term describes the difficulties that innovative start-ups encounter in defining their initial sales strategies.")
